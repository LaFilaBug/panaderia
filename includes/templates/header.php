        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/templates/contacto.html">Establecimientos</a></li>
                    <li><a href="/templates/menu.html">Menú</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/templates/registro.html">Registrarse</a></li>
                    <li><a href="/templates/inicioSesion.html">Iniciar sesión</a></li>
                </ul>
            </div>
        </div>
    </nav>
